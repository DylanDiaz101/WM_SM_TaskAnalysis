# SM WordWord Block 1 & Block 2 Analysis

import pandas as pd
import numpy as np

# IMPORTANT: DEFINE YOUR FILE PATHS - note that the 'r' is important before the file path i.e r"your_path"
datafile_PATH = r'C:\Users\dylan\Desktop\WM_SM_TaskAnalysis\example_data\sm_wordword_2\sm_wordword_2_raw_jreimer.csv' # should be a .csv file
desired_output_PATH = r'C:\Users\dylan\Desktop\WM_SM_TaskAnalysis\example_output\sm_wordword_block2_output.xlsx' # should be an .xlsx file
# ******************************************************************************** #
...
# Re-calculate with the count of blocknum 6 (or whatever you defined) for each subject and update the DataFrame with this information ----- *
